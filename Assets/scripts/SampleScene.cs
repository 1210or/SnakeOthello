...
public class SampleScene : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom() {
        ...
        GameObject player = PhotonNetwork.Instantiate("Player", StageMaker.stageObject[i * (StageMaker.stageSizeX - 1),i * (StageMaker.stageSizeZ - 1)].transform.position + new Vector3(0, 2, 0) , new Quaternion(1,0,0,180)); 
